...
public class BlockSteamBoiler extends BlockBasicMachine {
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (world.getTileEntity(pos) instanceof TileEntitySteamBoiler)
            return new ContainerSteamBoiler(player.inventory, (TileEntitySteamBoiler) world.getTileEntity(pos));
        return null;
    }
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        BlockPos pos = new BlockPos(x, y, z);
        if (world.getTileEntity(pos) instanceof TileEntitySteamBoiler)
            return new GuiSteamBoiler(player, (TileEntitySteamBoiler) world.getTileEntity(pos));
        return null;
    }
}
